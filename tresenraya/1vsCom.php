<?php
    ...
    if (isset($_GET['reiniciar'])) {
        session_destroy();
        header('Location: 1vsCom.php', true, 302);
    }
    ...
    $com=rand(0,8);
    for ($i=0; $i<=8; $i++){
        while ($_SESSION['posiciones'][$com]=='X' || $_SESSION['posiciones'][$com]=='O' ){
            $com=rand(0,8);
        }
    }
    for ($i=0; $i<=8; $i++) {
    ...
    if ($_SESSION['posiciones'][0] === 'X' &&
        ...
        header('Location: ganadormaquina.php', true, 302);
...
<!DOCTYPE HTML>
    ...
    <body style="background-image:url('fondo1vs1.jpg'); width:100%; height:100%;">
        <div class="container">
            <div class="jumbotron text-center">
                <h1 class="display-3">🧑1 VS COM💻</h1>
                <p class="lead">Has elegido jugar conta el ordenador, ¡MUCHA SUERTE!</p>
                <hr class="my-2"> 
            </div>
        </div>   
    ...
    if ($_SESSION['PJ1']['turno'] == true)
        ...
        echo '<h1 class="pj2">Ordenador: </h1>';
    ?>
    <br><br><br>
    <div style="text-align:center" id="casillas">
        <form method="get" action="1vsCom.php">
            <?php
            $j = 0;
            for ($i=0; $i<=8; $i++) {
